...
void printDebugFlagName( int level ) {
	...
	case 2: // DEBUG_SHOW_DEBOUNCE
		...
		break;
	case 3: // DEBUG_RENDEZVOUS
		Serial.print(F("DEBUG_RENDEZVOUS"));
		break;
	case 4: // DEBUG_DELTA_TIMER
		Serial.print(F("DEBUG_DELTA_TIMER"));
		break;
	case 5: // DEBUG_SLEEPING
		Serial.print(F("DEBUG_SLEEPING"));
		break;
	case 6: // DEBUG_BUTTON
		Serial.print(F("DEBUG_BUTTON"));
		break;
