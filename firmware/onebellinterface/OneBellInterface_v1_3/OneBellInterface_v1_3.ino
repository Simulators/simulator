...
Tested against Abel 3.9.1, Beltower 2015 (12.29) & Virtual Belfry 3.2.
	...
	1.3 : Update EEPROM handling code, simplified the CLI for setting simulator types (as
		option Q), and renamed the debounce timer command from U to B, consistent with main
		simulator interface code version 2.4.
		7,404 Bytes Flash, 222 Bytes SRAM.
