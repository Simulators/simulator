...
/*
 *********************************************************************************************
 *                                 Function debugThisBell()                                  *
 *********************************************************************************************
*/

// If debugging is enabled, and debugging is turned on for this bell in the mask, return TRUE.
// Otherwise return FALSE. debugMode and debugBellMask are global, so no need to pass them in
// via the function.

boolean	debugThisBell( int thisBell ) {

  if ( debugMode && bitRead( debugBellMask, thisBell) ) {
    // Debugging is enabled and turned on for this bell.
    return true;
  }
  else
  {
...
// Print a debugMask as fixed and spaced width binary, LSB (usually treble) first, showing
